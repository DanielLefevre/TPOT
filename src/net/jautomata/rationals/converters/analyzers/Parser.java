package net.jautomata.rationals.converters.analyzers;

import net.jautomata.rationals.Automaton;
import net.jautomata.rationals.converters.ConverterException;
import net.jautomata.rationals.transformations.Concatenation;
import net.jautomata.rationals.transformations.Mix;
import net.jautomata.rationals.transformations.Reducer;
import net.jautomata.rationals.transformations.Shuffle;
import net.jautomata.rationals.transformations.Star;
